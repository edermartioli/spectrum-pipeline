"""
    ...
    Description: Pipeline to process ECHARPE data using the SPECTRUM pipeline
    ...
    python -W"ignore" ~/spectrum-pipeline/scripts/echarpe_pipeline.py
    """
...
try:
    ...
    print("Error: check usage with -h echarpe_pipeline.py")
    sys.exit(1)
